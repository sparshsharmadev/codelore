  ...
  return (
    <div className="flex-1 overflow-y-auto" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
      <div className="max-w-xl mx-auto px-8 py-8">
        ...
        {/* Header */}
        <div className="text-xs text-zinc-700 mb-1">{`// ai-generated · tailored to vercel/next-commerce`}</div>
        ...
        <div className="mt-8 border border-zinc-800 px-4 py-4">
          ...
          <p className="text-xs text-zinc-600 leading-relaxed">
            after running <code className="px-1 py-0.5 border border-zinc-800 bg-zinc-900">pnpm dev</code>, open the Network tab in DevTools on a product page. the shopify graphql call won't appear — it happens server-side in a server component fetch.
          </p>
        </div>
      </div>
    </div>
